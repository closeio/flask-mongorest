...
from example import documents, schemas
    ...
    def update_object(self, obj, data=None, save=True, parent_resources=None):
        ...
        if data.get("author"):
            ...
            if author.email == "vincent@vangogh.com":
                obj.tags.append("art")
        return super(PostResource, self).update_object(
            obj, data, save, parent_resources
        )
...
class LimitedPostResource(Resource):
    document = documents.Post
    related_resources = {"content": ContentResource}
...
class PersonResource(Resource):
    ...
    related_resources = {"languages": LanguageResource}
